package com.bank.bian.crossborderpayment.model;
...
/**
 * The BIAN control record for this service domain: "Cross Border Payment Procedure".
 *
 ...
 * to its asset type (Cross Border Payment). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Cross Border Payment Procedure";
